  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-evenly bg-gradient-to-br from-sky-200 to-orange-200 p-5 dark:from-sky-950 dark:to-orange-950">
      <div className="relative flex flex-col place-items-center justify-center">
        <h1 className="bg-gradient-to-br from-sky-600 via-bl to-orange-900 bg-clip-text font-mono text-4xl font-bold text-transparent dark:from-sky-700 dark:to-orange-300/80 sm:text-5xl md:text-7xl xl:text-9xl">
          Create Quick App
        </h1>
      ...
      <div className="grid text-center dark:text-white lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <a
          href="https://nextjs.org/docs?utm_source=create-next-app&utm_medium=appdir-template&utm_campaign=create-next-app"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-slate-300 hover:bg-slate-100 hover:dark:border-slate-600 hover:dark:bg-slate-500/30"
          target="_blank"
