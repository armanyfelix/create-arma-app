  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-evenly bg-gradient-to-br from-sky-200 to-orange-200 p-5 dark:from-sky-950 dark:to-orange-950">
      <div className="relative flex flex-col place-items-center justify-center">
        <h1 className="bg-gradient-to-br from-sky-600 to-orange-900 bg-clip-text font-mono text-4xl font-bold text-transparent dark:from-sky-600 dark:to-orange-400 sm:text-5xl md:text-7xl xl:text-9xl">
          Create Quick App
        </h1>
        <p className="mt-14 text-center font-semibold dark:text-gray-300 sm:text-lg text-base md:text-2xl xl:text-3xl">
